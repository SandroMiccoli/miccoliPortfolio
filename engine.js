(function (root) {
	...
	root.SynthEngine = {
		...
		init: function () {
			...
			const vert = src.vert;
			['lines', 'noise', 'camera', 'warp', 'lookup', 'ramp', 'hsv', 'levels', 'contrast', 'kaleidoscope', 'bloomBright', 'bloomDown', 'bloomUp', 'bloomComp', 'edge', 'copy', 'maskShape', 'cornerPin', 'testCard', 'shape', 'gradient', 'displace', 'blur', 'feedback', 'transform', 'glitch'].forEach(function (name) {
